...
$courants = [
  ...
  ['aesthetic-movement',  'Q1050297',  'Aesthetic Movement',         '#b8860b', '"Palatino Linotype", serif',          1868, 1901, -4.5,  1.5,  7.5, 2],
  ['jugendstil',          'Q34627',    'Jugendstil',                 '#8fbc8f', '"Palatino Linotype", serif',          1896, 1910,  5.0,  2.2,  5.5, 2],
  ['vorticism',           'Q193699',   'Vorticism',                  '#ff4500', '"Impact", sans-serif',                1914, 1920, -6.5,  3.0,  1.8, 2],
  ['neoplasticisme',      'Q744239',   'Néoplasticisme',              '#f7c500', '"Helvetica Neue", sans-serif',        1917, 1931,  4.0,  2.8,  0.2, 2],
  ['new-typography',      null,        'New Typography',              '#d62828', '"Helvetica Neue", sans-serif',        1928, 1950,  1.5,  0.5, -0.5, 2],
  ['ulm-school',          'Q680909',   'École d\'Ulm',               '#457b9d', '"Helvetica Neue", sans-serif',        1953, 1968, -1.5,  0.8, -1.2, 2],
  ['streamline',          'Q185023',   'Streamline Moderne',          '#cd9b1d', '"Times New Roman", serif',            1930, 1950,  6.5,  1.8, -1.0, 2],
  ['op-art',              'Q80113',    'Op Art',                      '#2d6a4f', '"Helvetica Neue", sans-serif',        1964, 1975, -4.0,  0.0, -7.5, 2],
  ['lettrisme',           'Q200654',   'Lettrisme',                   '#7b2d8b', '"Courier New", monospace',            1945, 1975, -6.0,  2.8, -1.5, 2],
  ['psychedelic-poster',  null,        'Affiches Psychédéliques',     '#c77dff', '"Trebuchet MS", cursive',             1966, 1972,  7.0,  3.8,-10.5, 2],
  ['deconstruction-typo', null,        'Déconstruction Typo',         '#e056a0', '"Times New Roman", serif',            1988, 1998,  3.5, -2.5,-12.5, 2],
  ['neo-pop',             null,        'Neo-Pop',                     '#ffc300', '"Impact", sans-serif',                1980, 1995,  6.0,  2.2, -8.0, 2],
  ['material-design',     'Q17030296', 'Material Design',             '#03a9f4', '"Roboto", sans-serif',                2014, 9999,  0.5,  0.5,-18.5, 2],
  ['synthwave',           'Q27611341', 'Synthwave',                   '#f72585', '"Courier New", monospace',            2012, 9999,  6.0,  3.0,-19.0, 2],
  ['lo-fi-aesthetic',     null,        'Lo-fi Aesthetic',             '#b392ac', '"Courier New", monospace',            2015, 9999,  3.0,  3.5,-19.5, 2],
];
